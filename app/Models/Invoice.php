...
{
    use HasFactory;
    protected $fillable = ['buyer_name', 'buyer_phone', 'invoice_code', 'subtotal', 'discount', 'total_amount',
    'paid_amount', 'change', 'user_id','client_id','type','installment_amount','company'];
