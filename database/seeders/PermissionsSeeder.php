...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        $permissions = [
            ...
            'products' => ['عرض المنتجات', 'إنشاء المنتجات', 'تعديل المنتجات', 'عرض تقارير المنتجات','حذف المنتجات'],
            'cashier' => ['عرض عربة التسوق', 'إدارة الفواتير', 'عرض المنتجات','تحديث الخصم', 'إرجاع المنتجات المختارة','إضافة المنتج الي الفاتورة'],
            'sales_invoices' => ['عرض الفواتير', 'إنشاء الفواتير', 'عرض تقارير المبيعات','عرض الاقساط','اضافة قسط','تعديل قسط'],
            'purchase_invoices' => ['عرض فواتير الشراء', 'إضافة فاتورة شراء', 'إدارة الموردين','حذف فاتورة الشراء','حذف مورد'],
            'reports' => ['عرض تقرير الأقساط اليومية', 'عرض تقارير المنتجات', 'عرض تقارير المبيعات', 'عرض التقارير الشهرية', 'عرض التقارير اليومية'],
            'permissions' => ['إدارة الصلاحيات'],
            'maintenance' => ['عرض فواتير الصيانة', 'عرض عملاء الصيانة','حذف فاتورة صيانة'],
            'treasury' => ['عرض الخزينة'],
            'villages' => ['إدارة القري'],
            'clients' => ['حذف عميل','تحديث حالة العميل'],
        ];
