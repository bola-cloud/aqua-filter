    ...
    <div class="card p-3">
        ...
        <form action="{{ route('maintenances.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="maintenance_cost" id="maintenance_cost" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="maintenance_date">تاريخ الصيانة</label>
                <input type="date" name="maintenance_date" id="maintenance_date" class="form-control" value="{{ now()->format('Y-m-d') }}" required>
            </div>
